...
local Window = Rayfield:CreateWindow({
	Name = "Doors Entity Replicator Dex | "..(identifyexecutor and identifyexecutor() or syn and "Synapse X" or "Unknown".. " Dex Edition"),
	LoadingTitle = "Loading Doors Entity Spawner Dex | "..(identifyexecutor and identifyexecutor() or syn and "Synapse X" or "Unknown".. " Dex Edition"),
	LoadingSubtitle = "Made by Zepsyy and Spongus and ╰⊱♥⊱╮ღ꧁__Index🗕 🗗 🗙꧂ღ╭⊱♥≺",
	ConfigurationSaving = {
		Enabled = true,
...
local misc=Window:CreateTab("Misc", 29402763) 
--#endregion
